        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultCalendarView = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NotificationEnabled = table.Column<bool>(type: "bit", nullable: false),
                    DefaultReminder = table.Column<int>(type: "int", nullable: false),
                    FirstDayOfWeek = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Settings", x => x.Email);
                });
